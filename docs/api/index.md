...
*Générée le 2025-12-19 à 11:48*

Cette documentation couvre **28** fichiers GDScript du projet SimStation.

## Controller

- [game_end_manager](api/game_end_manager) - `controller\game_end_manager.gd`
...
- [crop_bar](api/crop_bar) - `model\hud\statistics\crop_bar.gd`
...
- [inventory_ui](api/inventory_ui) - `model\hud\inventory\inventory_ui.gd`
...
- [new_game](api/new_game) - `model\main_menu\new_game.gd`
- [pause](api/pause) - `model\pause\pause.gd`
- [save_slot](api/save_slot) - `model\main_menu\save_slot.gd`
- [saved_game](api/saved_game) - `model\main_menu\saved_game.gd`
- [settings](api/settings) - `model\pause\settings.gd`
- [shop](api/shop) - `model\shop\shop.gd`
- [tutorial](api/tutorial) - `model\main_menu\tutorial.gd`
