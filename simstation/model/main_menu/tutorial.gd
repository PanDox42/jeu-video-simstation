...
var tuto_data = [
	...
	["res://assets/tutorial/capture_options.PNG", "Vous pouvez régler vos paramètres de jeu dans l'onglet Options"],
	["res://assets/tutorial/capture_new_game.PNG", "Pour lancer une nouvelle partie, cliquez sur Nouveau dans le menu principal"],
	...
	["res://assets/tutorial/capture_stats_descend.PNG", "Vos stats descendent trop vite ? Ajoutez une chaufferie pour chauffer vos bâtiments !"],
	["res://assets/tutorial/capture_stats_stable.PNG", "1 chaufferie peut chauffer jusqu'à 2 bâtiments au maximum"],
	...
	["res://assets/tutorial/capture_pas_encore_win.PNG", "Pour gagner, vous devez finir toutes les recherches du labo"],
